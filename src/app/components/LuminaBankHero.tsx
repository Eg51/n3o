...
export default function LuminaBankHero() {
  return (
    <section className="w-full h-auto bg-transparent px-6 py-6 text-white">
        ...
        <nav className="flex items-center justify-between border-b border-white/5 pb-5">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden items-center gap-7 text-sm text-slate-300 sm:flex">
              <Link href={"#"} className="hover:text-white">Personal</Link>
              <Link href={"#"} className="hover:text-white">Business</Link>
              <Link href={"#"} className="hover:text-white">Investment</Link>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 gap-12 py-14 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
          ...
          <div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-4">
              <button
                type="button"
                className="flex items-center gap-2 rounded-md bg-cyan-400 px-5 py-2.5 text-sm
                 font-semibold text-slate-900 transition hover:bg-cyan-300"
              >
                Get Started
              ...
              <button
                type="button"
                className="rounded-md border border-white/20 px-5 py-2.5 text-sm font-semibold
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-br
             from-blue-200 via-cyan-200 to-purple-200 p-6 shadow-lg">
              ...
              <div className="mt-4 flex flex-col gap-3">
                ...
                <button
                  type="button"
                  className="mt-1 rounded-md border border-cyan-700/40 bg-cyan-700/10 py-2.5 text-sm font-semibold
                   text-cyan-800 transition hover:bg-cyan-700/20"
                >
                  Secure Sign In
                </button>
              </div>
              ...
              <div className="mt-4 flex items-center justify-between text-[11px] text-slate-600">
                ...
                <span>
                  New here?{" "}
                  <Link href="#" className="font-medium text-cyan-800 hover:underline">
                    Create Account
                  </Link>
                </span>
              </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-[11px] text-slate-300">
              ...
              <span className="flex gap-3">
                <span>
                  LaUM <span className="text-emerald-400">+1.24%</span>
                </span>
                <span>
