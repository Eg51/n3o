    ...
    <section className="w-full rounded-3xl bg-radial from-blue-200 via-cyan-200 to-purple-200 px-6 py-16 text-white">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-8 rounded-2xl border border-white/10 bg-white/[0.03] p-8 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div>
            <h3 className="text-xl text-cyan-400 font-semibold">Advanced Growth Tools</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#0a0e17]">
            ...
            <div className="mt-6 space-y-3">
              <div className="rounded-lg border border-cyan-400/40 bg-cyan-400/[0.06] p-3.5">
                <p className="text-xl font-semibold text-cyan-400">
                  Dynamic Runway Tracking
                </p>
                <p className="mt-1 text-xs leading-relaxed text-[#0a0e17]">
          ...
          <div className="rounded-xl border border-none bg-gradient-to-br from-blue-200 via-cyan-200 to-purple-200  to-gray-300 p-5">
            ...
            <div className="mt-5 grid grid-cols-2 gap-4">
              <div className="rounded-lg border border-none p-4">
                <p className="text-[10px] tracking-wide text-[#0a0e17]">
                  EQUITY BALANCE
                </p>
            ...
            <div className="mt-4 rounded-lg border border-white/10 p-4">
              <p className="text-[10px] tracking-widetext-[#0a0e17]">
