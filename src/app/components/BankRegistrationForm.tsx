              ...
              <motion.div key="form">
                      ...
                      >
                        {isActive && (
                          <motion.span
                            ...
                            className="absolute inset-0 rounded-md bg-cyan-400/[0.06] border-none cursor-pointer shadow-sm"
                          />
                        )}
                        <span
                          className={`relative ${
                            isActive ? "text-cyan-400 cursor-pointer" : "text-slate-600 cursor-pointer"
                          }`}
                        >
                          {type}
                        </span>
                ...
                <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <motion.div variants={fieldVariants}>
                    ...
                    <div className="flex items-center gap-2 rounded-md border-none bg-cyan-400/[0.06] px-3 py-2.5 shadow-xl
                  ...
                  <motion.div variants={fieldVariants}>
                    ...
                    <div className="flex items-center gap-2 rounded-md border border-none 
                      bg-cyan-400/[0.06] px-3 py-2.5
                ...
                <motion.div variants={fieldVariants} className="mt-4">
                  ...
                  <div className="flex items-center gap-2 rounded-md border-none bg-cyan-400/[0.06] shadow-xl
                ...
                <motion.div variants={fieldVariants} className="mt-4">
                  ...
                  <div className="flex items-center gap-2 rounded-md border-none border-slate-400/60
                   bg-cyan-400/[0.06] shadow-xl px-3 py-2.5 focus-within:border-cyan-600 focus-within:ring-1
                    ...
                    <button
                      ...
                      className="text-slate-500 hover:text-slate-700 className='text-cyan-700"
                    >
                ...
                <motion.div variants={fieldVariants} className="mt-4">
                  ...
                  <div className="flex items-center gap-2 rounded-md border border-none
                   bg-cyan-400/[0.06] shadow-xl px-3 py-2.5 focus-within:border-cyan-600
